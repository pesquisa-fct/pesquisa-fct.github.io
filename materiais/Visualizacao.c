...
void ImprimeArquivoVTK(double **u, double **v, double **p, double **psi, double **omega, double **txx, double **txy, double **tyy, double x0, double xf, double y0, double yf, double *x, double *y, int Nx, int Ny, int n){
    ...
    //Criando os arquivos
    sprintf(nomeArq, "../Results/8Lx8L_M2_Re1_PTT/Dados-N%d.vtk", n);
